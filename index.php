    ...
    <hr width = "70%"> 
       ...
       <?php  
        ...
        ?>
            ...
            <span><?php $res['id'] ?></span>
            <tr>
              <th width="100px">留言者</th>
              <th width="100px"><?php echo $res['author'] ?></th>
              <th width="100px">時間</th>
              <th width="100px"><?php echo $res['time'] ?></th>
              <th width="100px"><a href =" del.php?id=<?php echo $res['author'] ?>"><input type='submit' value='刪除'></input></th>
            </tr>
            <tr>
              <td align="center" width="100px">留言內容</td>
              <td width="100px" colspan="3"><?php echo $res['liuyan']  ?></td>
              <td align="center"><a href =" edit.php?id=<?php echo $res['liuyan'] ?>"><input type='submit' value='修改'></input></td>
            </tr>
          </table> 
